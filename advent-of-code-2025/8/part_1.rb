...
points.keys.combination(2).sort_by { |p1, p2| distance(p1, p2) }.take(limit).each do |(x1, y1, z1), (x2, y2, z2)|
...
p points.group_by { |_, v| v }.sort_by { |_, v| -v.size }.take(3).map { |_, v| v.size }.reduce(:*)
