...
result = bricks.count do |brick|
  brick.supporting.all? do |supporting_brick|
    bricks.select { |b| b.i != brick.i }.any? { |other_brick| other_brick.supporting.include?(supporting_brick) }
  end
end
